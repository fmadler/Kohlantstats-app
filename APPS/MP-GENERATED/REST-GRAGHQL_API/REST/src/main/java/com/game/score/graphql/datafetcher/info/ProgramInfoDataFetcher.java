...
@Component
public class ProgramInfoDataFetcher implements DataFetcher<List<ProgramInfoOut>>{
    ...
    @Override
    public List<ProgramInfoOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        ProgramInfoIn programInfoIn = new ProgramInfoIn ();
        programInfoIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
