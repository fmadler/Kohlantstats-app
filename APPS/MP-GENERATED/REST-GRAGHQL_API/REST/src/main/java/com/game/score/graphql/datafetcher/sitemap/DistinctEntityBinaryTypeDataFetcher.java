...
public class DistinctEntityBinaryTypeDataFetcher implements DataFetcher<List<DistinctEntityBinaryTypeOut>>{
    ...
    @Override
    public List<DistinctEntityBinaryTypeOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        DistinctEntityBinaryTypeIn distinctEntityBinaryTypeIn = new DistinctEntityBinaryTypeIn ();
        distinctEntityBinaryTypeIn.setEntityTypeWebPath (dataFetchingEnvironment.getArgument("entityTypeWebPath"));
        return distinctEntityBinaryTypeDaoFace.execute (
        	distinctEntityBinaryTypeIn
            ).getDistinctEntityBinaryTypeOuts();
    }
