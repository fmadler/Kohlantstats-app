...
/**
*
* <p>Title: GameDetailResource</p>
*
* <p>Description: class for GameDetailResource service </p>
*
*/
@Path("/composite/GameDetailIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/composite/GameDetailIn", description = "operation about GameDetailIn")
public class GameDetailResource {
    @Autowired
    @Qualifier("gameDetailDaoFace")	
GameDetailDaoFace gameDetailDaoFace;

    @GET
    @ApiOperation(value = "game_detail", response = GameDetailOut.class)
    @ApiResponses(value = {
    	@ApiResponse(code = 200, message = "ok")
    })
    public GameDetailOut execute (
        ...
        return gameDetailDaoFace.execute(
			new GameDetailIn(
				 entityType
				, entityWebPath
				, property
