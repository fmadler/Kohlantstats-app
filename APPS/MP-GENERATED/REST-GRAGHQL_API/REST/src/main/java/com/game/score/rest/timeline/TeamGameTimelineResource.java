...
@Api(value="/sdd/TeamGameTimelineIn", description = "operation about TeamGameTimelineIn")
public class TeamGameTimelineResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "team_game_timeline", notes = "perform team_game_timeline", response = TeamGameTimelineOutList.class)
    @ApiResponses(value = {
	...
	public TeamGameTimelineOutList callImplementation (
		...
		teamGameTimelineIn.setProgramWebPath (programWebPath);
		teamGameTimelineIn.setTeamWebPath (teamWebPath);
		teamGameTimelineIn.setGameWebPath (gameWebPath);
		teamGameTimelineIn.setGameTypeWebPath (gameTypeWebPath);
		teamGameTimelineIn.setPlayerWebPath (playerWebPath);
