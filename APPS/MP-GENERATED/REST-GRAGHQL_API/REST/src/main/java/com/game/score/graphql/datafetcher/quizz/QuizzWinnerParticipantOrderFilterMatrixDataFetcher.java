...
public class QuizzWinnerParticipantOrderFilterMatrixDataFetcher implements DataFetcher<List<QuizzWinnerParticipantOrderFilterMatrixOut>>{
    ...
    @Override
    public List<QuizzWinnerParticipantOrderFilterMatrixOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        ...
        quizzWinnerParticipantOrderFilterMatrixIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        quizzWinnerParticipantOrderFilterMatrixIn.setGameWebPath (dataFetchingEnvironment.getArgument("gameWebPath"));
        return quizzWinnerParticipantOrderFilterMatrixDaoFace.execute (
        	quizzWinnerParticipantOrderFilterMatrixIn
            ).getQuizzWinnerParticipantOrderFilterMatrixOuts();
    }
