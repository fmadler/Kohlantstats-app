...
/**
*
* <p>Title: ParticipantCampActivityResource</p>
*
* <p>Description: class for ParticipantCampActivityResource service </p>
*
*/
@Path("/sdd/ParticipantCampActivityIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/ParticipantCampActivityIn", description = "operation about ParticipantCampActivityIn")
public class ParticipantCampActivityResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "participant_camp_activity", notes = "perform participant_camp_activity", response = ParticipantCampActivityOutList.class)
    @ApiResponses(value = {
	...
	public ParticipantCampActivityOutList callImplementation (
		...
		participantCampActivityIn.setProgramWebPath (programWebPath);
		participantCampActivityIn.setTeamWebPath (teamWebPath);
		participantCampActivityIn.setPlayerWebPath (playerWebPath);
