...
@Component
public class DistinctTeamsDataFetcher implements DataFetcher<List<DistinctTeamsOut>>{
    ...
    @Override
    public List<DistinctTeamsOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        DistinctTeamsIn distinctTeamsIn = new DistinctTeamsIn ();
        distinctTeamsIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        return distinctTeamsDaoFace.execute (
        	distinctTeamsIn
            ).getDistinctTeamsOuts();
    }
