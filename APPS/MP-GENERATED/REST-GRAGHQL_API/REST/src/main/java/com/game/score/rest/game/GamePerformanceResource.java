...
/**
*
* <p>Title: GamePerformanceResource</p>
*
* <p>Description: class for GamePerformanceResource service </p>
* <p>Convention: $query.getNamingConvention() </p>
*
*/
@Path("/sdd/GamePerformanceIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/GamePerformanceIn", description = "operation about GamePerformanceIn")
public class GamePerformanceResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "game_performance", notes = "perform game_performance", response = GamePerformanceOutList.class)
    @ApiResponses(value = {
	...
	public GamePerformanceOutList callImplementation (
         String playerWebPath
        ,         String programWebPath
	) {
        GamePerformanceIn gamePerformanceIn = new GamePerformanceIn ();
		gamePerformanceIn.setPlayerWebPath (playerWebPath);
		gamePerformanceIn.setProgramWebPath (programWebPath);
