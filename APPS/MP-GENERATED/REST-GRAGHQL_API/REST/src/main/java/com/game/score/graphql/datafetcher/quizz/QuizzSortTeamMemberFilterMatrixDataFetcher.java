...
@Component
public class QuizzSortTeamMemberFilterMatrixDataFetcher implements DataFetcher<List<QuizzSortTeamMemberFilterMatrixOut>>{
    ...
    @Override
    public List<QuizzSortTeamMemberFilterMatrixOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        QuizzSortTeamMemberFilterMatrixIn quizzSortTeamMemberFilterMatrixIn = new QuizzSortTeamMemberFilterMatrixIn ();
        quizzSortTeamMemberFilterMatrixIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        quizzSortTeamMemberFilterMatrixIn.setGameWebPath (dataFetchingEnvironment.getArgument("gameWebPath"));
        return quizzSortTeamMemberFilterMatrixDaoFace.execute (
        	quizzSortTeamMemberFilterMatrixIn
            ).getQuizzSortTeamMemberFilterMatrixOuts();
    }
