...
/**
*
* <p>Title: QuizzWinnerTeamOrderOptionResource</p>
*
* <p>Description: class for QuizzWinnerTeamOrderOptionResource service </p>
* <p>Convention: $query.getNamingConvention() </p>
*
*/
@Path("/sdd/QuizzWinnerTeamOrderOptionIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/QuizzWinnerTeamOrderOptionIn", description = "operation about QuizzWinnerTeamOrderOptionIn")
public class QuizzWinnerTeamOrderOptionResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "quizz_winner_team_order_option", notes = "perform quizz_winner_team_order_option", response = QuizzWinnerTeamOrderOptionOutList.class)
    @ApiResponses(value = {
	...
	public QuizzWinnerTeamOrderOptionOutList callImplementation (
         String programWebPath
        ,         String gameWebPath
	) {
        QuizzWinnerTeamOrderOptionIn quizzWinnerTeamOrderOptionIn = new QuizzWinnerTeamOrderOptionIn ();
		quizzWinnerTeamOrderOptionIn.setProgramWebPath (programWebPath);
		quizzWinnerTeamOrderOptionIn.setGameWebPath (gameWebPath);
