...
/**
*
* <p>Title: DistinctTeamsResource</p>
*
* <p>Description: class for DistinctTeamsResource service </p>
*
*/
@Path("/sdd/DistinctTeamsIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/DistinctTeamsIn", description = "operation about DistinctTeamsIn")
public class DistinctTeamsResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "distinct_teams", notes = "perform distinct_teams", response = DistinctTeamsOutList.class)
    @ApiResponses(value = {
	...
	public DistinctTeamsOutList callImplementation (
         String programWebPath
	) {
        DistinctTeamsIn distinctTeamsIn = new DistinctTeamsIn ();
		distinctTeamsIn.setProgramWebPath (programWebPath);
        return distinctTeamsDaoFace.execute(
        	distinctTeamsIn
        );
	}
