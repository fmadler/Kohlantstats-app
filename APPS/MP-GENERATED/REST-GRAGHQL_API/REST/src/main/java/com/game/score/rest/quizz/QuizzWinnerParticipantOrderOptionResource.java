...
/**
*
* <p>Title: QuizzWinnerParticipantOrderOptionResource</p>
*
* <p>Description: class for QuizzWinnerParticipantOrderOptionResource service </p>
*
*/
@Path("/sdd/QuizzWinnerParticipantOrderOptionIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/QuizzWinnerParticipantOrderOptionIn", description = "operation about QuizzWinnerParticipantOrderOptionIn")
public class QuizzWinnerParticipantOrderOptionResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "quizz_winner_participant_order_option", notes = "perform quizz_winner_participant_order_option", response = QuizzWinnerParticipantOrderOptionOutList.class)
    @ApiResponses(value = {
	...
	public QuizzWinnerParticipantOrderOptionOutList callImplementation (
         String programWebPath
        ,         String gameWebPath
	) {
        QuizzWinnerParticipantOrderOptionIn quizzWinnerParticipantOrderOptionIn = new QuizzWinnerParticipantOrderOptionIn ();
		quizzWinnerParticipantOrderOptionIn.setProgramWebPath (programWebPath);
		quizzWinnerParticipantOrderOptionIn.setGameWebPath (gameWebPath);
