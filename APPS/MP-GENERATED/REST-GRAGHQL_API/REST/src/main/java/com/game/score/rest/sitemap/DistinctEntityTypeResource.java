...
/**
*
* <p>Title: DistinctEntityTypeResource</p>
*
* <p>Description: class for DistinctEntityTypeResource service </p>
* <p>Convention: $query.getNamingConvention() </p>
*
*/
@Path("/sdd/DistinctEntityTypeIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/DistinctEntityTypeIn", description = "operation about DistinctEntityTypeIn")
public class DistinctEntityTypeResource {
    @Autowired
    @Qualifier("distinctEntityTypeDaoFace")
	DistinctEntityTypeDaoFace distinctEntityTypeDaoFace;
	

    @GET
    @Cacheable(cc = "public, max-age=3600")
	@Compress
    @ApiOperation(value = "distinct_entity_type", notes = "perform distinct_entity_type", response = DistinctEntityTypeOutList.class)
    @ApiResponses(value = {
	...
	public DistinctEntityTypeOutList callImplementation (
	) {
        return distinctEntityTypeDaoFace.execute(
        );
	}
