...
@Component
public class QuizzParticipationFilterMatrixDataFetcher implements DataFetcher<List<QuizzParticipationFilterMatrixOut>>{
    ...
    @Override
    public List<QuizzParticipationFilterMatrixOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        QuizzParticipationFilterMatrixIn quizzParticipationFilterMatrixIn = new QuizzParticipationFilterMatrixIn ();
        quizzParticipationFilterMatrixIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        quizzParticipationFilterMatrixIn.setGameWebPath (dataFetchingEnvironment.getArgument("gameWebPath"));
        quizzParticipationFilterMatrixIn.setParticipationTypeWebPath (dataFetchingEnvironment.getArgument("participationTypeWebPath"));
        return quizzParticipationFilterMatrixDaoFace.execute (
        	quizzParticipationFilterMatrixIn
            ).getQuizzParticipationFilterMatrixOuts();
    }
