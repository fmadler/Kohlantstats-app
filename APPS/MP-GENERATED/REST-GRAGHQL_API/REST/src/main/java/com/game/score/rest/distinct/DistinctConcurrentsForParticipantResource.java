...
/**
*
* <p>Title: DistinctConcurrentsForParticipantResource</p>
*
* <p>Description: class for DistinctConcurrentsForParticipantResource service </p>
* <p>Convention: $query.getNamingConvention() </p>
*
*/
@Path("/sdd/DistinctConcurrentsForParticipantIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/DistinctConcurrentsForParticipantIn", description = "operation about DistinctConcurrentsForParticipantIn")
public class DistinctConcurrentsForParticipantResource {
    @Autowired
	...
	@Compress
    @ApiOperation(value = "distinct_concurrents_for_participant", notes = "perform distinct_concurrents_for_participant", response = DistinctConcurrentsForParticipantOutList.class)
    @ApiResponses(value = {
    	@ApiResponse(code = 200, message = "ok")
    })
    public DistinctConcurrentsForParticipantOutList execute (
        @ApiParam(value = "playerWebPath", required = true) @QueryParam ("playerWebPath")  String playerWebPath
    ) {
	...
	public DistinctConcurrentsForParticipantOutList callImplementation (
		...
		distinctConcurrentsForParticipantIn.setPlayerWebPath (playerWebPath);
