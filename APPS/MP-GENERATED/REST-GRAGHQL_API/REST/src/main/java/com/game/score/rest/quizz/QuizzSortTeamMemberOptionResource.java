...
/**
*
* <p>Title: QuizzSortTeamMemberOptionResource</p>
*
* <p>Description: class for QuizzSortTeamMemberOptionResource service </p>
*
*/
@Path("/sdd/QuizzSortTeamMemberOptionIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/sdd/QuizzSortTeamMemberOptionIn", description = "operation about QuizzSortTeamMemberOptionIn")
public class QuizzSortTeamMemberOptionResource {
    @Autowired
    @Qualifier("quizzSortTeamMemberOptionDaoFace")
	QuizzSortTeamMemberOptionDaoFace quizzSortTeamMemberOptionDaoFace;
	

    @GET
    @Cacheable(cc = "public, max-age=3600")
	@Compress
    @ApiOperation(value = "quizz_sort_team_member_option", notes = "perform quizz_sort_team_member_option", response = QuizzSortTeamMemberOptionOutList.class)
    @ApiResponses(value = {
	...
	public QuizzSortTeamMemberOptionOutList callImplementation (
         String programWebPath
        ,         String gameWebPath
        ,         String teamWebPath
        ,         String participantWebPath
	) {
        QuizzSortTeamMemberOptionIn quizzSortTeamMemberOptionIn = new QuizzSortTeamMemberOptionIn ();
		quizzSortTeamMemberOptionIn.setProgramWebPath (programWebPath);
		quizzSortTeamMemberOptionIn.setGameWebPath (gameWebPath);
		quizzSortTeamMemberOptionIn.setTeamWebPath (teamWebPath);
		quizzSortTeamMemberOptionIn.setParticipantWebPath (participantWebPath);
        return quizzSortTeamMemberOptionDaoFace.execute(
