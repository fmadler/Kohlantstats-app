...
*/
package com.game.score.graphql.datafetcher.generic;
...
@Component
public class MasterDataDataFetcher implements DataFetcher<List<MasterDataOut>> {
    ...
    @Override
    public List<MasterDataOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
    String table = dataFetchingEnvironment.getArgument("table");
