...
*/
package com.game.score.graphql.datafetcher.player;
...
public class PlayerPerformanceComparisonDataFetcher implements DataFetcher<List<PlayerPerformanceComparisonOut>> {
    ...
    @Override
    public List<PlayerPerformanceComparisonOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        PlayerPerformanceComparisonIn playerPerformanceComparisonIn = new PlayerPerformanceComparisonIn ();
        playerPerformanceComparisonIn.setComparisonPlayersWebPath (dataFetchingEnvironment.getArgument("comparisonPlayersWebPath"));
        playerPerformanceComparisonIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        return playerPerformanceComparisonDaoFace.execute (
        	playerPerformanceComparisonIn
            ).getPlayerPerformanceComparisonOuts();
    }
