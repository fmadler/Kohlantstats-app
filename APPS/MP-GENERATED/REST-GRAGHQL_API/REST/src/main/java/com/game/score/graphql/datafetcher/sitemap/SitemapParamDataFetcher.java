...
public class SitemapParamDataFetcher implements DataFetcher<List<SitemapParamOut>>{
    ...
    @Override
    public List<SitemapParamOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        SitemapParamIn sitemapParamIn = new SitemapParamIn ();
        sitemapParamIn.setEntityTypeWebPath (dataFetchingEnvironment.getArgument("entityTypeWebPath"));
        sitemapParamIn.setContextTypeWebPath (dataFetchingEnvironment.getArgument("contextTypeWebPath"));
        sitemapParamIn.setName (dataFetchingEnvironment.getArgument("name"));
