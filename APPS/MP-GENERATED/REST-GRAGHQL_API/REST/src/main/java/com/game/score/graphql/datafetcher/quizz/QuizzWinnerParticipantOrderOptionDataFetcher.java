...
@Component
public class QuizzWinnerParticipantOrderOptionDataFetcher implements DataFetcher<List<QuizzWinnerParticipantOrderOptionOut>>{
    ...
    @Override
    public List<QuizzWinnerParticipantOrderOptionOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        QuizzWinnerParticipantOrderOptionIn quizzWinnerParticipantOrderOptionIn = new QuizzWinnerParticipantOrderOptionIn ();
        quizzWinnerParticipantOrderOptionIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        quizzWinnerParticipantOrderOptionIn.setGameWebPath (dataFetchingEnvironment.getArgument("gameWebPath"));
        return quizzWinnerParticipantOrderOptionDaoFace.execute (
        	quizzWinnerParticipantOrderOptionIn
            ).getQuizzWinnerParticipantOrderOptionOuts();
    }
