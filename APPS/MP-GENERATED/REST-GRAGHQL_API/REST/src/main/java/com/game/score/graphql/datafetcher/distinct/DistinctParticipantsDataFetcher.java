...
@Component
public class DistinctParticipantsDataFetcher implements DataFetcher<List<DistinctParticipantsOut>>{
    ...
    @Override
    public List<DistinctParticipantsOut> get(DataFetchingEnvironment dataFetchingEnvironment) {
        DistinctParticipantsIn distinctParticipantsIn = new DistinctParticipantsIn ();
        distinctParticipantsIn.setProgramWebPath (dataFetchingEnvironment.getArgument("programWebPath"));
        return distinctParticipantsDaoFace.execute (
        	distinctParticipantsIn
            ).getDistinctParticipantsOuts();
    }
