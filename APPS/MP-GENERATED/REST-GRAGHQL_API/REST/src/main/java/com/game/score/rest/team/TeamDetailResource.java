...
/**
*
* <p>Title: TeamDetailResource</p>
*
* <p>Description: class for TeamDetailResource service </p>
*
*/
@Path("/composite/TeamDetailIn")
@Produces(MediaType.APPLICATION_JSON)
@Api(value="/composite/TeamDetailIn", description = "operation about TeamDetailIn")
public class TeamDetailResource {
    @Autowired
    @Qualifier("teamDetailDaoFace")	
TeamDetailDaoFace teamDetailDaoFace;

    @GET
    @ApiOperation(value = "team_detail", response = TeamDetailOut.class)
    @ApiResponses(value = {
    	@ApiResponse(code = 200, message = "ok")
    })
    public TeamDetailOut execute (
        ...
        return teamDetailDaoFace.execute(
			new TeamDetailIn(
				 entityType
				, entityWebPath
				, property
