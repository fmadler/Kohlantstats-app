...
*/
package com.game.score.composite.in.info;
...
/**
 *
 * <p>Title: ParticipantCampActivityInfoIn</p>
 *
 * <p>Description: Java Bean Input composite</p>
 *
 */
@Data
public class ParticipantCampActivityInfoIn {

	public ParticipantCampActivityInfoIn (
		...
		this.distinctTeamsIn = new DistinctTeamsIn();
		this.distinctTeamsIn.setProgramWebPath(programWebPath);
    ...
    private DistinctTeamsIn distinctTeamsIn;
