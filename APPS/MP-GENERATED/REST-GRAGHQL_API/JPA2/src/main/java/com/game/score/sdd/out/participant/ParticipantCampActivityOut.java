...
/**
 *
 * <p>Title: ParticipantCampActivityOut</p>
 *
 * <p>Description: ParticipantCampActivity Java Bean </p>
 *
 */
@Data
public class ParticipantCampActivityOut {

    private String programName;
    private String programWebPath;
    private String teamName;
    private String teamWebPath;
    private Integer teamFromTime;
    private String teamToTime;
    private String playerName;
    private String playerWebPath;
    private Integer participantId;
    private String teamPlayerEntranceType;
    private Integer teamPlayerFromTime;
    private String teamPlayerDepartureType;
    private Integer teamPlayerToTime;
	@Data
	public class Realisations {
		String name;
		String webPath;
	}
    private List<Realisations> realisations;
