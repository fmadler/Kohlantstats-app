...
*/
package com.game.score.service.impl.participant;
...
import com.game.score.service.face.participant.ParticipantCampActivityService;

/**
 *
 * <p>Title: ParticipantCampActivityServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("participantCampActivityService")
@Transactional
public class ParticipantCampActivityServiceImpl implements ParticipantCampActivityService{
    @Autowired
