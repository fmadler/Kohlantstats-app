...
import com.game.score.service.face.distinct.DistinctTeamsService;

/**
 *
 * <p>Title: DistinctTeamsServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctTeamsService")
@Transactional
public class DistinctTeamsServiceImpl implements DistinctTeamsService{
    @Autowired
