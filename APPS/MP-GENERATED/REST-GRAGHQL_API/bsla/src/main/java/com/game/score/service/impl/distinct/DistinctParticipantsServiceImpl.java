...
import com.game.score.service.face.distinct.DistinctParticipantsService;

/**
 *
 * <p>Title: DistinctParticipantsServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctParticipantsService")
@Transactional
public class DistinctParticipantsServiceImpl implements DistinctParticipantsService{
    @Autowired
