...
*/
package com.game.score.service.impl.distinct;
...
import com.game.score.service.face.distinct.DistinctConcurrentsForParticipantService;

/**
 *
 * <p>Title: DistinctConcurrentsForParticipantServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctConcurrentsForParticipantService")
@Transactional
public class DistinctConcurrentsForParticipantServiceImpl implements DistinctConcurrentsForParticipantService{
    @Autowired
