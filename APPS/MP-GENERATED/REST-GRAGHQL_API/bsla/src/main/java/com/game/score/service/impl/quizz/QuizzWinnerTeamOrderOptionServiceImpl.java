...
import com.game.score.service.face.quizz.QuizzWinnerTeamOrderOptionService;

/**
 *
 * <p>Title: QuizzWinnerTeamOrderOptionServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzWinnerTeamOrderOptionService")
@Transactional
public class QuizzWinnerTeamOrderOptionServiceImpl implements QuizzWinnerTeamOrderOptionService{
    @Autowired
