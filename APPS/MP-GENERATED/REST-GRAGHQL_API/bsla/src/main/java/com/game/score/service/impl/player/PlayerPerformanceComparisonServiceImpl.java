...
*/
package com.game.score.service.impl.player;
...
import com.game.score.service.face.player.PlayerPerformanceComparisonService;

/**
 *
 * <p>Title: PlayerPerformanceComparisonServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("playerPerformanceComparisonService")
@Transactional
public class PlayerPerformanceComparisonServiceImpl implements PlayerPerformanceComparisonService{
    @Autowired
