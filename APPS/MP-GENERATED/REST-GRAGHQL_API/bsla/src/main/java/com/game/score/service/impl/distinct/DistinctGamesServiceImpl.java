...
import com.game.score.service.face.distinct.DistinctGamesService;

/**
 *
 * <p>Title: DistinctGamesServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctGamesService")
@Transactional
public class DistinctGamesServiceImpl implements DistinctGamesService{
    @Autowired
