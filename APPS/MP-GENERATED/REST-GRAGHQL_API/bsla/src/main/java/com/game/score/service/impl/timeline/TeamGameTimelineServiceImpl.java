...
import com.game.score.service.face.timeline.TeamGameTimelineService;

/**
 *
 * <p>Title: TeamGameTimelineServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("teamGameTimelineService")
@Transactional
public class TeamGameTimelineServiceImpl implements TeamGameTimelineService{
    @Autowired
