...
import com.game.score.service.face.sitemap.DistinctEntityBinaryTypeService;

/**
 *
 * <p>Title: DistinctEntityBinaryTypeServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctEntityBinaryTypeService")
@Transactional
public class DistinctEntityBinaryTypeServiceImpl implements DistinctEntityBinaryTypeService{
    @Autowired
