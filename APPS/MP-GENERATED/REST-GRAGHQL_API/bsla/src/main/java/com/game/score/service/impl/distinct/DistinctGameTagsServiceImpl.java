...
import com.game.score.service.face.distinct.DistinctGameTagsService;

/**
 *
 * <p>Title: DistinctGameTagsServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctGameTagsService")
@Transactional
public class DistinctGameTagsServiceImpl implements DistinctGameTagsService{
    @Autowired
