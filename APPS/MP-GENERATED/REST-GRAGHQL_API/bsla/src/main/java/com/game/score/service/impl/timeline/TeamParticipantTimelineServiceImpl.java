...
*/
package com.game.score.service.impl.timeline;
...
import com.game.score.service.face.timeline.TeamParticipantTimelineService;

/**
 *
 * <p>Title: TeamParticipantTimelineServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("teamParticipantTimelineService")
@Transactional
public class TeamParticipantTimelineServiceImpl implements TeamParticipantTimelineService{
    @Autowired
