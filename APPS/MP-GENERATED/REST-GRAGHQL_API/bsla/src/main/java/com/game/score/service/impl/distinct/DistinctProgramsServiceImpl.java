...
import com.game.score.service.face.distinct.DistinctProgramsService;

/**
 *
 * <p>Title: DistinctProgramsServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("distinctProgramsService")
@Transactional
public class DistinctProgramsServiceImpl implements DistinctProgramsService{
    @Autowired
