...
import com.game.score.service.face.quizz.QuizzSortTeamMemberOptionService;

/**
 *
 * <p>Title: QuizzSortTeamMemberOptionServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzSortTeamMemberOptionService")
@Transactional
public class QuizzSortTeamMemberOptionServiceImpl implements QuizzSortTeamMemberOptionService{
    @Autowired
