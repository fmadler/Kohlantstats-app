...
import com.game.score.service.face.quizz.QuizzSortTeamMemberFilterMatrixService;

/**
 *
 * <p>Title: QuizzSortTeamMemberFilterMatrixServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzSortTeamMemberFilterMatrixService")
@Transactional
public class QuizzSortTeamMemberFilterMatrixServiceImpl implements QuizzSortTeamMemberFilterMatrixService{
    @Autowired
