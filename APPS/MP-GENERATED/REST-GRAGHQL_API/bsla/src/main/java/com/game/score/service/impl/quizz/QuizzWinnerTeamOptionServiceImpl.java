...
import com.game.score.service.face.quizz.QuizzWinnerTeamOptionService;

/**
 *
 * <p>Title: QuizzWinnerTeamOptionServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzWinnerTeamOptionService")
@Transactional
public class QuizzWinnerTeamOptionServiceImpl implements QuizzWinnerTeamOptionService{
    @Autowired
