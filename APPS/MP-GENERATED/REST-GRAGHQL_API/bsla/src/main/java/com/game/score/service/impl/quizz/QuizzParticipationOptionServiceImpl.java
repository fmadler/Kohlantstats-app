...
import com.game.score.service.face.quizz.QuizzParticipationOptionService;

/**
 *
 * <p>Title: QuizzParticipationOptionServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzParticipationOptionService")
@Transactional
public class QuizzParticipationOptionServiceImpl implements QuizzParticipationOptionService{
    @Autowired
