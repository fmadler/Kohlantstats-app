...
import com.game.score.service.face.quizz.QuizzWinnerParticipantOrderFilterMatrixService;

/**
 *
 * <p>Title: QuizzWinnerParticipantOrderFilterMatrixServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzWinnerParticipantOrderFilterMatrixService")
@Transactional
public class QuizzWinnerParticipantOrderFilterMatrixServiceImpl implements QuizzWinnerParticipantOrderFilterMatrixService{
    @Autowired
