...
import com.game.score.service.face.quizz.QuizzWinnerTeamMatrixService;

/**
 *
 * <p>Title: QuizzWinnerTeamMatrixServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzWinnerTeamMatrixService")
@Transactional
public class QuizzWinnerTeamMatrixServiceImpl implements QuizzWinnerTeamMatrixService{
    @Autowired
