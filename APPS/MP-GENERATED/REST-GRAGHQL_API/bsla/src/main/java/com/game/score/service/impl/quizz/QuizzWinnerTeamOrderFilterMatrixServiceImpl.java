...
import com.game.score.service.face.quizz.QuizzWinnerTeamOrderFilterMatrixService;

/**
 *
 * <p>Title: QuizzWinnerTeamOrderFilterMatrixServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("quizzWinnerTeamOrderFilterMatrixService")
@Transactional
public class QuizzWinnerTeamOrderFilterMatrixServiceImpl implements QuizzWinnerTeamOrderFilterMatrixService{
    @Autowired
