...
import com.game.score.service.face.timeline.ScoreTimelineService;

/**
 *
 * <p>Title: ScoreTimelineServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("scoreTimelineService")
@Transactional
public class ScoreTimelineServiceImpl implements ScoreTimelineService{
    @Autowired
