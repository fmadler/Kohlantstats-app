...
import com.game.score.service.face.team.CreateParticipantRealisationService;

/**
 *
 * <p>Title: CreateParticipantRealisationServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("createParticipantRealisationService")
@Transactional
public class CreateParticipantRealisationServiceImpl implements CreateParticipantRealisationService{
    @Autowired
