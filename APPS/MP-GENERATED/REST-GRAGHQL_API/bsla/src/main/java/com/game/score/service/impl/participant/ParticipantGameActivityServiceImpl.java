...
import com.game.score.service.face.participant.ParticipantGameActivityService;

/**
 *
 * <p>Title: ParticipantGameActivityServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("participantGameActivityService")
@Transactional
public class ParticipantGameActivityServiceImpl implements ParticipantGameActivityService{
    @Autowired
