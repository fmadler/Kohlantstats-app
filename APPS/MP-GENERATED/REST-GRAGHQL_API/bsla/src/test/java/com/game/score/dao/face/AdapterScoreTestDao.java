...
*/
package com.game.score.dao.face;
...
@ContextConfiguration(locations={
     "classpath:com/game/score/factory/spring/spring-config-Score-BE-main.xml"
})
@TransactionConfiguration(transactionManager = "scoreTransactionManager") 
@Transactional
public class AdapterScoreTestDao extends AbstractTransactionalJUnit4SpringContextTests { 
