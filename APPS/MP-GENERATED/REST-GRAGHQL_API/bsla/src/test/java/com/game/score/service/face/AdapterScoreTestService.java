...
*/
package com.game.score.service.face;
...
@ContextConfiguration(locations={
     "classpath:factory/spring/Score-service-application-context.xml"
})
@TransactionConfiguration(transactionManager = "scoreTransactionManager") 
@Transactional
public class AdapterScoreTestService extends AbstractTransactionalJUnit4SpringContextTests { 
