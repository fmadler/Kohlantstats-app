export const klsSiteUrl= "http://localhost:4400/";

export const optionPoursuite2020Option = [
...
export const mock = {
    seasons : [
        {
            name:"Les armes secrètes",
            webPath:"les-armes-secretes",
            games : [
                {
                    name:"Parcours du combattant",
                    webPath:"parcours-du-combattant-2021",
                    participationTypeWebPath : "individuel",
                    winner : {
                        name :"Laure",
                        webPath : "laure-2021"
                    }
        ...
        {
            name:"Les quatre terres",
            webPath:"les-quatre-terres",
            participants : [
                {
                    name:"Loïc",
                    webPath:"loic-2020",
...
export const loic_Les4terres_score_first = mock.seasons[1].participants[0].score.first;
export const loic_Les4terres_score_second = mock.seasons[1].participants[0].score.second;
