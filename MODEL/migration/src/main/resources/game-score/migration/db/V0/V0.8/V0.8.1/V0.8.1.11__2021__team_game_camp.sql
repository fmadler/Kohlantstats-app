...
call first_vote_against ('les-armes-secretes','laetitia-2021','thomas-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','flavio-2021','magali-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','lucie-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','vincent-2021','magali-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','arnaud-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','magali-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','thomas-2021','vincent-2021','blanc-2021', 26, 'effectif');
call second_vote_against ('les-armes-secretes','thomas-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','jonathan-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','maxine-2021','vincent-2021','blanc-2021', 26, 'effectif');
call first_vote_against ('les-armes-secretes','laure-2021','vincent-2021','blanc-2021', 26, 'effectif');

call create_participant_departure('les-armes-secretes','vincent-2021','blanc-2021',26,'exclusion-par-vote', @participant_team_id);
call create_participant_departure('les-armes-secretes','laetitia-2021','blanc-2021',26,'exclusion-par-vote', @participant_team_id);
