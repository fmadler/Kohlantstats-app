...
drop procedure IF EXISTS fill_participant_longevity$$
create procedure fill_participant_longevity
(
	_program_web_path varchar(100),
    _player_web_path varchar(45),
    _final_position int,
...
begin
	...
	END IF;
    update gs_participant set final_position = _final_position, start_day = _start_day, end_day = _end_day
    where id = @participant_id
    ;
