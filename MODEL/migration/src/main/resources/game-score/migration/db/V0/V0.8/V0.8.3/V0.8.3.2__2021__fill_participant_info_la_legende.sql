...
call add_participant('la-legende-2021', 'Jade', '', 'jade-2007', 'F', 39, null, 0, '', '');
-- Handi
call add_participant('la-legende-2021', 'Karima', '', 'karima-2016', 'F', 26, null, 17, '', 'Militaire');
-- Najjarine
call add_participant('la-legende-2021', 'Teheiura', '', 'teheiura-2011', 'M', 43, null, 0, '', '');
-- teahui
...
-- Noblat
call add_participant('la-legende-2021', 'Alexandra', '', 'alexandra-2020', 'F', 32, null, 0, '', '');
-- pornet
call add_participant('la-legende-2021', 'Sam', '', 'sam-2018', 'M', 44, null, 0, '', '');
-- haliti
call add_participant('la-legende-2021', 'Christelle', '', 'christelle-2008', 'F', 41, null, 0, '', '');
-- Gauzet  
