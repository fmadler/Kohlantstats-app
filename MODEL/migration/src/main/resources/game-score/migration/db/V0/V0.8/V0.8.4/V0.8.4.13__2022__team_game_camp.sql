...
call create_game_participation('francois-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',1,'toilette-massage,bien-etre');
call create_game_participation('fouzi-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',1,'vote-contre-soi');
call create_game_participation('louana-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',1,'');
call create_game_participation('ambre-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',1,'toilette-massage,bien-etre');
call create_game_participation('bastien-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',1,'');

call create_game_participation('nicolas-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',2,'');
call create_game_participation('maxime-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',2,'');
call create_game_participation('geraldine-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',2,'');
call create_game_participation('olga-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',2,'');
call create_game_participation('anne-sophie-2022','blanc-2022','tir-a-l-arc-2022','participant','collectif',2,'');


call create_game_participation('jean-charles-2022','blanc-2022','tir-a-l-arc-2022','exclus-par-non-choix','collectif',10,'');
...
call create_game_participation('louana-2022','blanc-2022','parcours-du-combattant-2022','participant','individuel',1,'');
...
call create_game_participation('francois-2022','blanc-2022','parcours-du-combattant-2022','participant','individuel',0,'totem');
