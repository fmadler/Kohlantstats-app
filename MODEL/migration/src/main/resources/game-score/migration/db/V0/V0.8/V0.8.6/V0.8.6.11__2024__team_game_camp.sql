...
call create_game('les-chasseurs-d-immunite','Tir à l''arc','tir-a-l-arc-2024','tir-a-l-arc','individuel','confort',18,24,'nage-avec-requin-baleine,nuit-hotel,avantage-strategique','precision,strategie');
...
call create_game_participation('amri-2024','blanc-2024','table-bascule-2024','participant','individuel',8,'');
call create_game_participation('pauline-2024','blanc-2024','table-bascule-2024','participant','individuel',7,'');
...
call second_vote_against ('les-chasseurs-d-immunite','megane-2024','amri-2024','blanc-2024', 26, 'annule-par-collier-immunite');
